...
import com.sidharth.exception.DuplicateResourceException;
import com.sidharth.exception.RequestValidationException;
import com.sidharth.exception.ResourceNotFoundException;
import com.sidharth.s3.S3Buckets;
import com.sidharth.s3.S3Service;
...
public class CustomerService {
    ...
    public byte[] getCustomerProfileImage(Integer customerId) {
        ...
        System.out.printf("profile-images/%s/%s%n", customerId, customer.profileImageId());
